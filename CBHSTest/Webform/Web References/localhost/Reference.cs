...
namespace Webform.localhost {
    ...
    public partial class MemberService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public MemberService() {
            this.Url = global::Webform.Properties.Settings.Default.Webform_localhost_MemberService;
        ...
        public System.Data.DataTable InsertMember(string firstName, string lastName, string email, string dateOfBirth) {
        ...
        /// <remarks/>
        public void InsertMemberAsync(string firstName, string lastName, string email, string dateOfBirth) {
            this.InsertMemberAsync(firstName, lastName, email, dateOfBirth, null);
        }
        
        /// <remarks/>
        public void InsertMemberAsync(string firstName, string lastName, string email, string dateOfBirth, object userState) {
            ...
            this.InvokeAsync("InsertMember", new object[] {
                        ...
                        lastName,
                        email,
                        dateOfBirth}, this.InsertMemberOperationCompleted, userState);
        }
